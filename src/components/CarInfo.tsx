...
const CarInfo: React.FC<CarInfoProps> = ({ isDollar, ...props }) => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const response3 = await fetch(
        `https://api2.myauto.ge/ka/getManModels?man_id=${props.man_id}`
      );
  ...
  useEffect(() => {
    if (isDollar) {
      if (props.price_value === 0) {
        SetCarPrice("ფასი შეთანხმებით");
      } else {
        SetCarPrice(
          `${Math.round(props.price_usd)
            .toString()
            .replace(/\B(?=(\d{3})+(?!\d))/g, ",")}`
        );
      }
  ...
  return (
    <div>
      {isMobile ? (
        <div className="w-[377px] h-[494px] hover:border hover:border-[#61d9cb] mb-4 rounded-[10px]">
          <div className="flex flex-col w-[375px] h-[492px]   bg-white p-[15px] rounded-[10px] hover:bg-[#eaf2f4]">
            <div className="flex flex-row mb-[5px]">
              <div>
                <div className="flex flex-row items-center">
                  <div
                    className={`text-gray-800 text-[14px] font-normal ${
                      props.for_rent
                        ? "bg-green-600 text-white h-[24px] text-[12px] mr-[5px] pr-[8px] pl-[8px] pb-[3px] pt-[1px]  rounded-[5px] h-[18px]"
                        : ""
                    }`}
                  >
                    {ForRent}
              ...
              <div className="text-gray-800 text-[14px] font-medium ">
                {" "}
                {/* sruli saxeli */}
                {`${
                  manufacturer
                    .filter((info) => info.man_id === props.man_id.toString())
                    .find((info) => info.man_id === props.man_id.toString())
                    ?.man_name
                } ${
                  modelList
                    .filter((info) => info.model_id === props.model_id)
                    .find((info) => info.model_id === props.model_id)
                    ?.model_name
                } ${props.car_model}`}
              </div>
                ...
                <div className="flex flex-row items-center text-[20px] font-semibold">
                  ...
                  {props.price_value == 0 ? (
                    ...
                    <>
                      ...
                      <div>
                        {isDollar ? (
                          <div className="flex items-center justify-center w-[24px] h-[24px] rounded-full cursor-pointer bg-slate-200 text-gray-800 icon-gray-800">
                            <svg
                ...
                <div className="flex flex-col justify-center items-center ml-[150px]">
                  {Ganbajeba === "განბაჟება " ? (
                    <span style={{ color: "red" }}>
                      <div className="flex text-[12px]">განბაჟება</div>
                    </span>
                  ) : (
                    <span style={{ color: "green" }}>
                      <div className="flex flex-row items-center">
                        ...
                        <div className="flex text-[12px]">განბაჟებული</div>
                      </div>
                    </span>
                  )}
                </div>
            ...
            <div className="flex flex-col">
              {" "}
              {/* infoebi */}
              <div className="flex flex-row mb-1 ml-[12px]">
                {" "}
                {/* pirveli xazi */}
              </div>
              ...
              <div className="flex flex-row mb-1 ml-[12px]">
                {" "}
                {/* meore xazi */}
                <div className="flex flex-row mr-[10px] w-[174px]">
                  {" "}
                  {/* ragaca dzravi */}
                  ...
                  <div className="flex text-[13px]">
                    {`${(props.engine_volume / 1000).toPrecision(
                      2
                    )} ${getFuelType(props.fuel_type_id)}`}
                  </div>
                </div>
                <div className="flex flex-row items-center mr-[70px]">
                  {" "}
                  {/* gavlili mandzili */}
                  <div className="flex ">
                    <svg
                  ...
                  <div className="flex text-[13px]">{props.car_run} კმ</div>
                </div>
              </div>
              <div className="flex flex-row ml-[12px]">
                {" "}
                {/* mesame xazi */}
                <div className="flex flex-row mb-[10px] mr-[70px] w-[174px]">
                  {" "}
                  {/* ragaca dzravi2 :ddd */}
                ...
                <div className="flex flex-row items-center mr-[70px] ">
                  ...
                  <div className="flex text-[13px]">{wheelPosition}</div>
                </div>
              </div>
              <hr></hr>
              <div className="flex flex-row ml-[20px]">
                ...
                <div className="flex flex-row text-[12px] text-gray-400">
                  {timeDifferenceText}
                </div>
        ...
        <div className="w-[752px] h-[182px] hover:border hover:border-[#61d9cb] mb-4 rounded-[10px]">
          <div className="flex flex-row w-[750px] h-[180px]   bg-white p-[15px] rounded-[10px] hover:bg-[#eaf2f4]">
            <div className="flex">
              {" "}
              {/* surati */}
              <img
            ...
            <div className="flex flex-col">
              {" "}
              {/* infoebi */}
              <div className="flex flex-row mb-6 ml-[12px]">
                {" "}
                {/* pirveli xazi */}
                <div className="flex flex-row items-center w-[300px]">
                  ...
                  <div className="text-gray-800 text-[14px] font-medium ">
                    ...
                    {`${
                      manufacturer
                        .filter(
                          (info) => info.man_id === props.man_id.toString()
                        )
                        .find((info) => info.man_id === props.man_id.toString())
                        ?.man_name
                    } ${
              ...
              <div className="h-[20px]" />
              <div className="flex flex-row mb-4 ml-[12px]">
                {" "}
                {/* meore xazi */}
                <div className="flex flex-row mr-[70px] w-[174px]">
                  {" "}
                  {/* ragaca dzravi */}
                  <div className="flex mr-[6px]">
                    <svg
              ...
              <div className="flex flex-row ml-[12px] pl-[48px]">
                {" "}
                {/* meotxe xazi */}
