...
export const Context = React.createContext<
  [GlobalType, React.Dispatch<React.SetStateAction<GlobalType>>]
>([initialState, () => {}]);
...
export const Context2 = React.createContext<
  [GlobalCategoryType, React.Dispatch<React.SetStateAction<GlobalCategoryType>>]
>([initialStateCat, () => {}]);
...
export const Context3 = React.createContext<
  [GloablRentType, React.Dispatch<React.SetStateAction<GloablRentType>>]
>([initialStateRent, () => {}]);
...
export const Context4 = React.createContext<
  [GlobalManModelType, React.Dispatch<React.SetStateAction<GlobalManModelType>>]
>([initialStateManModel, () => {}]);
