...
function App() {
  ...
  const [buttonClasses, setButtonClasses] = useState(
    `flex items-center justify-center w-[24px] h-[24px] rounded-full cursor-pointer ${
      isDollar ? "bg-black" : "bg-slate-200"
    } text-gray-800 ${isDollar ? "icon-white" : "icon-gray-800"}`
  );
  const [buttonClasses2, setButtonClasses2] = useState(
    `flex items-center justify-center w-[24px] h-[24px] rounded-full cursor-pointer ${
      isDollar ? "bg-slate-200" : "bg-black"
    } text-gray-800 ${isDollar ? "icon-gray-800" : "icon-white"}`
  );
  ...
  const ManDropDown: React.FC<{ manufacturer: ManufacturerListType[] }> = ({
    ...
    useEffect(() => {
      const handleResize = () => {
        setIsMobile(window.innerWidth < 768); // Update the state based on the screen size condition
      };
    ...
    useEffect(() => {
      const buttonClasses1 = `flex items-center justify-center w-[24px] h-[24px] rounded-full cursor-pointer ${
        isDollar ? "bg-black" : "bg-slate-200"
      } ${isDollar ? "text-white" : "text-gray-800"} ${
        isDollar ? "icon-white" : "icon-gray-800"
      }`;
      const buttonClasses3 = `flex items-center justify-center w-[24px] h-[24px] rounded-full cursor-pointer ${
        isDollar ? "bg-slate-200" : "bg-black"
      } ${isDollar ? "text-gray-800" : "text-white"} ${
        isDollar ? "icon-gray-800" : "icon-white"
      }`;
        ...
        <div className="flex justify-center flex-col bg-gray-100">
          ...
          <div className="flex flex-no-wrap justify-center">
            <div className="flex justify-center items-center flex-col  ">
              <div>
                {filter ? (
                  <div className="flex flex-col items-center justify-center mr-20 h-[540px] p-[20px]">
                    {" "}
                    {/* marjvena mxare */}
                    ...
                    <div className="flex flex-col mr-20 h-[450px] w-[240px] p-[20px] ml-[50px] bg-white ">
                        ...
                        <div>
                          <ModelDropDown
                            models={modelsState.filter(
                              (model) =>
                                manufacturerPotential.hasOwnProperty(
                                  model.man_id
